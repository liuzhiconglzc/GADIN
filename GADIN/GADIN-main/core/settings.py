...
MIDDLEWARE = [
    ...
    # 下面发送post请求，先注释掉？todo,作用是发送post时，做校验
...
# TODO 数据库配置，这里用的是自带的sqllite3，可考虑使用mysql
DATABASES = {
    'default': {
...
# todo 如果使用mysql，在book.init_文件中，消除注释
# DATABASES = {
#     'default': {
...
STATIC_URL = '/static/'
# todo 这是配置 static文件夹，使用界面的第三方框架（静态框架），可引入css文件
